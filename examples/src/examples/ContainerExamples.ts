const basic = {
  title: 'Basic',
  code: `<Container p="1rem" w="15rem" style={{background: 'palegreen'}}>Hello World</Container>`,
...
const aFewDifferent = {
  ...
  code: `<>
  <Container p="1rem" w="10rem" style={{background: 'palegreen'}}>Hello World</Container>
