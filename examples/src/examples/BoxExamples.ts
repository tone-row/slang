...
const basic: Example = {
  title: 'Basic',
  code: `<Box style={{background: 'palegreen'}}>Hello World</Box>`,
...
const padding: Example = {
  title: 'Padding',
  code: `<Box p="1rem" style={{background: 'palegreen'}}>Hello World</Box>`,
...
const margin: Example = {
  title: 'Margin',
  code: `<Box m="1rem" style={{background: 'palegreen'}}>Hello World</Box>`,
  description: `The shorthand property for margin on all sides is **m**. It works just like padding.`
};

const axis: Example = {
  title: 'Axis',
  code: `<Box my="1rem" px="1rem" style={{background: 'palegreen'}}>Hello World</Box>`,
...
const specificSides: Example = {
  ...
  code: `<Box mt="1rem" mr="2rem" pb="1rem" pl="2rem" style={{background: 'palegreen'}}>Hello World</Box>`,
...
const overrides: Example = {
  title: 'Overrides',
  code: `<Box p="1rem" pt="3rem" style={{background: 'palegreen'}}>Hello World</Box>`,
