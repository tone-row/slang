...
import { Shape, Item } from '@tone-row/slang';

const basic: Example = {
  title: 'Basic',
  code: (
    <Shape ratio={3 / 4} style={{ background: 'var(--accent)' }}>
      <Item>I'll always be three by four.</Item>
    </Shape>
  ),
...
const overflowScroll: Example = {
  title: 'Scroll',
  code: (
    <Shape ratio={3 / 4} style={{ background: 'var(--accent)' }} oScroll>
      <Item>
        Sometimes you'll want to overflow: scroll these bad boys to make sure that the user can
        acces whatever is going on! Here some ipsum dude... Lorem ipsum dolor sit amet, consetetur
...
const overflowHidden: Example = {
  title: 'Hidden',
  code: (
    <Shape ratio={3 / 4} style={{ background: 'var(--accent)' }} oHidden>
      <Item>
        Sometimes you want the overflow oHidden! Lorem ipsum dolor sit amet, consetetur sadipscing
