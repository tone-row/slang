...
const basic: Example = {
  title: 'Basic',
  code: `<Shape ratio={3/4} style={{background: 'var(--accent)'}}><Item>I'll always be three by four.</Item></Shape>`,
