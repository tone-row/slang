...
const basic: Example = {
  title: 'Basic',
  code: (
    <Container p="1rem" w="15rem" style={{ background: 'var(--accent)' }}>
      Hello World
    </Container>
  ),
...
const aFewDifferent: Example = {
  title: 'Vertical Alignment',
  code: (
    <>
      <Container p="1rem" w="10rem" style={{ background: 'var(--accent)' }}>
        Hello World
      </Container>
      <Container p="2rem" w="14rem" style={{ background: 'mediumpurple' }}>
        My text aligns with the left edge of the others!
      </Container>
      <Container p="1rem" w="10rem" style={{ background: 'var(--accent)' }}>
        Hello World
      </Container>
